...
### Phase 1: 환경 설정 및 애플리케이션 골격 구축 (1-2일)

- **Task 001: 개발 환경 설정** - 우선순위
...
- **Task 003: 프로젝트 라우트 구조 완성**
  - 모든 페이지 라우트 골격 확인 및 보완
  - 공통 레이아웃 컴포넌트 구현 (`src/app/layout.tsx`)
  - 에러 바운더리 및 로딩 상태 컴포넌트 구현

### Phase 2: UI/UX 완성 - 더미 데이터 활용 (2-3일)
...
- **Task 008: Notion API 연동 - 회원 정보** - 우선순위
  - `getMember()` 함수 구현
